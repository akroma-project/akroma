...
import (
	...
	"github.com/akroma-project/akroma/internal/build"
	"github.com/akroma-project/akroma/params"
	sv "github.com/akroma-project/akroma/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/akroma-project/akroma/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/akroma-project/akroma/mobile")
...
func doXgo(cmdline []string) {
	...
	gogetxgo := goTool("get", "github.com/akroma-project/xgo")
