...
var (
	...
	app = utils.NewApp(gitCommit, "the akroma command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2019 The go-ethereum Authors, Copyright 2018-2022 The Akroma Project Authors"
