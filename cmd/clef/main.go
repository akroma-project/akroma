...
import (
	...
	"github.com/akroma-project/akroma/signer/rules"
...
func signer(c *cli.Context) error {
	...
	if c.Bool(utils.RPCEnabledFlag.Name) {
		...
		listener, _, err := rpc.StartHTTPEndpoint(httpEndpoint, rpcAPI, []string{"account"}, cors, vhosts, rpc.DefaultHTTPTimeouts, c.String(utils.RPCUserFlag.Name), c.String(utils.RPCPasswordFlag.Name))
		if err != nil {
