...
var (
	...
	TestnetChainConfig = &ChainConfig{
		...
		AkromaBlock:             big.NewInt(10),
		BaneslayerBlock:         big.NewInt(20),
		CopperLeafBlock:         big.NewInt(30),
		DawnbreakBlock:          big.NewInt(40),
		ExaltedAngelBlock:       big.NewInt(50),
		FlamebladeBlock:         big.NewInt(60),
		GabrielAngelfireBlock:   big.NewInt(70),
		HailstormValkyrieBlock:  big.NewInt(80),
		IonaBlock:               big.NewInt(90),
		JenaraBlock:             big.NewInt(100),
		KarmicGuideBlock:        big.NewInt(110),
		LinvalaBlock:            big.NewInt(120),
		MaelstromArchangelBlock: big.NewInt(130),
		PlatinumAngelBlock:      big.NewInt(140),
		RestorationAngelBlock:   big.NewInt(150),
		SerraAngelBlock:         big.NewInt(160),
		TwilightShepherdBlock:   big.NewInt(170),
		ValkyrieHarbingerBlock:  big.NewInt(180),
		WarriorAngelBlock:       big.NewInt(190),
		XathridDemonBlock:       big.NewInt(200),
		YouthfulValkyrieBlock:   big.NewInt(210),
		ZuranOrbBlock:           big.NewInt(220),
		Ethash:                  new(EthashConfig),
	}
