...
// IsConstantinople returns whether num is either equal to the Akroma fork block or greater.
...
// IsDawnbreak returns whether num is either equal to the CopperLeaf fork block or greater.
